...
function M.apply(spec, config)
  ...
  hi("TabLineSel", { fg = spec.bg1, bg = spec.fg3, bold = true })
  ...
  link("@markup.heading.5.markdown", "@markup.heading.1.markdown")
  link("@markup.heading.6.markdown", "@markup.heading.1.markdown")
